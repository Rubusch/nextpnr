...
struct MistralPacker
{
    ...
    void constrain_lutram()
    {
        ...
        // cells should be packed together, too This makes things easier for the place,ent legaliser to deal with RAM in
        // LAB-compatible blocks without over-constraining things
